---
title: Spring Cloud loadbalancer：负载均衡的服务调用
date: 2021-02-15 22:11:18
permalink: /pages/846776/
categories:
  - 企业级开发
tags:
  - Spring Cloud
...
> Spring Cloud Ribbon 是Spring Cloud Netflix 子项目的核心组件之一，主要给服务间调用及API网关转发提供负载均衡的功能，自Spring cloud2020.X版本以后，就移除了Netfix下面除eureka相关的所有项目。因此，本文主要针对它的升级替代组件spring cloud loadbalancer对其用法进行详细介绍。

## Loadbalancer简介

在微服务架构中，很多服务都会部署多个，其他服务去调用该服务的时候，如何保证负载均衡是个不得不去考虑的问题。负载均衡可以增加系统的可用性和扩展性，当我们使用RestTemplate来调用其他服务时，Loadbalancer可以很方便的实现负载均衡功能。
...
<img src="https://cdn.jsdelivr.net/gh/pixyshu/picgo@main/image/20220215094338.png" alt="image-20220215094337345" style="zoom:50%;" />
...
这里**需要注意**到：使用Spring Boot为2.5.9，使用了Spring cloud为2020.0.5。
...
<img src="http://www.macrozheng.com/images/springcloud_ribbon_01.png" style="zoom:75%;" />

-   此时运行中的服务如下：

![](http://www.macrozheng.com/images/springcloud_ribbon_02.png)

-   调用接口进行测试：[http://localhost:8301/user/1](http://localhost:8301/user/1)

![](http://www.macrozheng.com/images/springcloud_ribbon_05.png)

-   可以发现运行在8201和8202的user-service控制台交替打印如下信息：

![](http://www.macrozheng.com/images/springcloud_ribbon_03.png)

![](http://www.macrozheng.com/images/springcloud_ribbon_04.png)
