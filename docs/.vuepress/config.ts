...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "水生的网络日志",
      description: '后端开发技术博客，分享代码人生，包括观点感悟、读书笔记',
    }
  },
  ...
  themeConfig: {
    ...
    author: {
      name: '水生', // 必需
      link: 'https://github.com/pixyshu', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:pixyshu@qq.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/pixsyshu',
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: {
      ...
      copyrightInfo:
        '車轱辘 | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
